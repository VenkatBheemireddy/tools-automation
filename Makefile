...
ansible:
	...
	git pull
	ansible-playbook -i $(tool_name)-internal.azdevopsv82.online, tool-setup.yml -e ansible_user=venkat -e ansible_password=Devops123456 -e tool_name=$(tool_name) -var token=$(vault_token)